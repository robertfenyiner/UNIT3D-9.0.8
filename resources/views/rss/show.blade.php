        ...
        @if($torrents)
            @foreach($torrents as $torrent)
                ...
                <item>
                    ...
                    {{-- Etiquetas estándar para que Telegram y otros lectores muestren la imagen --}}
                    <media:content url="{{$poster}}" type="image/jpeg" medium="image" />
